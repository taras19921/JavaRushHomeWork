...
public class EsourcesCoUkSorted
{
    public static void main(String[] args)
    {
        // Apparel & Clothing
        List<String> pages = pages("https://www.esources.co.uk/wholesale-suppliers/25/");
        // Arts & Crafts
...
//            for (int i = 0; i < 1; i++)
    ...
    public static void createAndSaveExcelSheet(List<String> allPages)
    {
        ...
        try
        {
            file = new FileInputStream(new File("D:\\Freelance\\Lowcostseo\\UK - Sorted\\WS UK - Apparel & Clothing.xlsx"));
...
//Set value to new value
        ...
        finally
        {
            ...
            {
                file.close();
                outFile = new FileOutputStream(new File("D:\\Freelance\\Lowcostseo\\UK - Sorted\\WS UK - Apparel & Clothing.xlsx"));
