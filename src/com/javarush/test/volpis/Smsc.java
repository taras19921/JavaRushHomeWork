...
public class Smsc {
    ...
    String SMSC_LOGIN    = "salamat";     // логин клиента
    String SMSC_PASSWORD = "157f61dc3dfda4eb8285c52651442f15";  // пароль или MD5-хеш пароля в нижнем регистре
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        //Smsc sd= new Smsc();
        // or
        Smsc sd= new Smsc("salamat", "157f61dc3dfda4eb8285c52651442f15");
        //Smsc sd= new Smsc("salamat", "salamat");
        //Smsc sd= new Smsc();

        sd.send_sms("0984631462", "Тест", 1, "", "", 0, "", "");
